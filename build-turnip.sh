...
mesaver="https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-24.3.3/mesa-mesa-24.3.3.zip"
mesadir="mesa-mesa-24.3.3"
...
META_FILE="meta.json"
ZIP_FILE="Turnip-24.3.3-EMULATOR.zip"
...
zip -r $workdir/Turnip-24.3.3-MAGISK-KSU.zip * &> /dev/null
if ! [ -a $workdir/Turnip-24.3.3-MAGISK-KSU.zip ]; then
...
{
  "schemaVersion": 1,
  "name": "Freedreno Turnip Driver v24.3.3",
...
# Zip the turnip .so file and meta.json file
    ...
    echo $workdir/Turnip-24.3.3-MAGISK-KSU.zip $'\n'
    echo $workdir/Turnip-24.3.3-EMULATOR.zip $'\n'
