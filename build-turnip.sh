...
mesaver="https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-24.2.6/mesa-mesa-24.2.6.zip"
mesadir="mesa-mesa-24.2.6"
...
META_FILE="meta.json"
ZIP_FILE="Turnip-24.2.6-EMULATOR.zip"
...
zip -r $workdir/Turnip-24.2.6-MAGISK-KSU.zip * &> /dev/null
if ! [ -a $workdir/Turnip-24.2.6-MAGISK-KSU.zip ]; then
...
{
  "schemaVersion": 1,
  "name": "Freedreno Turnip Driver v24.2.6",
...
# Zip the turnip .so file and meta.json file
    ...
    echo $workdir/Turnip-24.2.6-MAGISK-KSU.zip $'\n'
    echo $workdir/Turnip-24.2.6-EMULATOR.zip $'\n'
