...
META_FILE="meta.json"
ZIP_FILE="Turnip-24.3.4-EMULATOR.zip"
...
zip -r $workdir/Turnip-24.3.4-MAGISK-KSU.zip * &> /dev/null
if ! [ -a $workdir/Turnip-24.3.4-MAGISK-KSU.zip ]; then
...
# Zip the turnip .so file and meta.json file
    ...
    echo $workdir/Turnip-24.3.4-MAGISK-KSU.zip $'\n'
